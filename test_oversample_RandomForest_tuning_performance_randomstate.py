...
state_options = [0,10,50,100]
for n in state_options:
    tstart = time.process_time()
    classifier = RandomForestClassifier(n_estimators=100,max_depth=50,min_samples_leaf=1,
                 max_features=200,min_samples_split=2,random_state=n,criterion='entropy')
