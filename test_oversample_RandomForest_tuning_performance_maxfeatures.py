...
features_options = [1,10,50,100,200,500]
for n in features_options:
    tstart = time.process_time()
    classifier = RandomForestClassifier(n_estimators=200,max_depth=16,min_samples_leaf=5,max_features=n,min_samples_split=2,random_state=0,criterion='entropy')
